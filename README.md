...
1. **search-[items]** - Automated discovery
   - Priority-based search queries
   - Time filtering (recent vs. historical)
   - Duplicate detection
   - TODO list updates

2. **add-[item]** - Standardized addition
...
Built with [skill-creator](https://github.com/anthropics/skill-creator) guidelines:
...
Built using the [skill-creator](https://github.com/anthropics/skill-creator) framework by Anthropic.
